		...
		<div data-options="region:'north'" style="height: 50px">
			<form id="searchForm" method="post">
				<table>
					<tr>
						<td>用户名称：</td>
						<td><input id="userName" name="userName" class="easyui-textbox" data-options="prompt:'输入用户名称...'" style="width: 100%; height: 32px"></td>
						<td>备注</td>
						<td><input id="note" name="note" class="easyui-textbox" data-options="prompt:'输入备注...'" style="width: 100%; height: 32px">
						</td>
