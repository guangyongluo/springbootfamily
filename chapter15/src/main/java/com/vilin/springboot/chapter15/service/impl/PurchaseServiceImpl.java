package com.vilin.springboot.chapter15.service.impl;

import com.vilin.springboot.chapter15.dao.ProductDao;
import com.vilin.springboot.chapter15.dao.PurchaseRecordDao;
import com.vilin.springboot.chapter15.pojo.ProductPo;
import com.vilin.springboot.chapter15.pojo.PurchaseRecordPo;
import com.vilin.springboot.chapter15.service.PurchaseService;
...
//		try {
			...
			keys.add(PRODUCT_SCHEDULE_SET);
			keys.add(PURCHASE_PRODUCT_LIST);
			List<String> params = new ArrayList<String>();
			DefaultRedisScript<Long> redisScript = new DefaultRedisScript<>(purchaseScript, Long.class);
			Long result = (Long)redisTemplate.execute(redisScript, keys, userId, productId, quantity, purchaseDate);
		return result == 1;
			// 获取原始连接
//			jedis = (Jedis) redisTemplate
